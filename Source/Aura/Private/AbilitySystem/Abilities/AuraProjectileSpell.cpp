...
FString UAuraProjectileSpell::GetDescription(int32 Level)
{
	...
	if (Level == 1)
	{
		return FString::Printf(TEXT("<Title>FIRE BALL</>\n\n<Default>Launches a ball of fire, exploding on impact and dealing: </><Damage>%d</><Default> fire damage with a chance to burn</>\n\n<Small>Level: </><Level>%d</>"), Damage, Level);
	}
	else
	{
		return FString::Printf(TEXT("<Title>FIRE BALL</>\n\n<Default>Launches %d balls of fire, exploding on impact and dealing: </><Damage>%d</><Default> fire damage with a chance to burn</>\n\n<Small>Level: </><Level>%d</>"), FMath::Min(Level, NumProjectiles), Damage, Level);
	}
}
